<script lang="ts">
	...
	function selectFont(fontName: string) {
		...
		// Load Google Fonts CSS for live preview
						...
						<div class="space-y-4">
							...
							<div>
								...
								<div class="relative">
									...
									{#if showFontDropdown && (fontSearchResults.length > 0 || fontSearchLoading)}
										<div class="absolute z-50 top-full left-0 right-0 mt-1 max-h-48 overflow-y-auto rounded-lg border border-zinc-700 bg-zinc-900 shadow-xl">
											{#if fontSearchLoading}
												<div class="px-3 py-4 text-center text-xs text-zinc-500">
													<svg class="h-4 w-4 animate-spin mx-auto mb-1" fill="none" viewBox="0 0 24 24">
														<circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
														<path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
													</svg>
													Searching fonts...
